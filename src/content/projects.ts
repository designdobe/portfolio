...
export const projects: Project[] = [
  {
    ...
    sections: [
      {
        heading: "Before",
        body: "장기간 인테리어 업체 주도의 단독 공사가 진행되었습니다. 이로 인해 입면 마감재가 파편화되며 브랜드 정체성이 명확하지 않았고, 투입 공사비 대비 결과물의 퀄리티가 불규칙했습니다. 또한 일정 및 현황이 투명하게 공유되지 않아, 주방 설비 및 외부 사인물 업체 간의 공정 충돌과 재작업 리스크가 빈번하게 발생하는 심각한 관리 비효율을 초래하고 있었습니다. 사인디자인 역시 실제 시공 방식을 고려하지 않은 비효율적인 형태를 유지하고 있었으며, 월 그래픽 등 내부 시각물에 대한 세부 가이드가 부재하여 비용 대비 저품질의 시공이 지속되는 상황이었습니다.",
      },
      {
        heading: "After",
  ...
  },
  {
    ...
    category: "SPACE",
    featured: true,
    role: "BX Directing 80% (동선 및 행사기획, 부스 및 MD상품 디자인, 견적관리)",
    tools: "Illustrator, Photoshop, Sketchup, Dimension",
    overview:
    ...
    media: [
      { src: "/work/kurly-food-festa/01.jpg", caption: "부스 전경" },
      { src: "/work/kurly-food-festa/02.jpg", caption: "스토리텔링 부적 굿즈" },
    ],
  },
  {
    slug: "gukbap-master",
  ...
  },
  {
    ...
    category: "SPACE",
    featured: true,
    role: "공간기획(주방 및 테이블동선 외 시각요소 100%), 시공디렉팅(80%), 매장채널운영(100%)",
    ...
    sections: [
      ...
      {
        heading: "채널별 역할",
        body: "네이버는 이용자 수가 가장 많은 플랫폼으로 매장 기본정보와 리뷰 댓글을 이용한 메세지 전달, 블로그 체험단 컨텐츠와 연계되는 주요 소통수단으로 이용했습니다. 당근은 소식과 쿠폰발행으로 지역기반 고객에게 직접 침투하는 채널로, 카카오맵은 별점의 교차 검증 플랫폼으로 기본 셋팅을 성실히 유지했습니다. 청계천 인근 매장 특성상 외국인 유입이 많아 구글 비즈니스에는 메뉴와 매장소식을 영문과 교차발행했습니다.",
      },
      {
        heading: "리뷰 가이드와 현장 피드백",
        body: "순대국집에서 겪는 고객의 대표적인 페인포인트를 예비 고객이 사전에 해소할 수 있도록 특정 키워드를 활용한 리뷰가이드를 작성했습니다. 부정적인 리뷰는 현장에 즉시 전달해 빠르게 개선했습니다. 6월 29일 '아기의자가 없어서 아쉬워요' 리뷰는 현장 전달 후 개선되어, 7월 31일 '직원분들이 친절하게 유아의자도 먼저 준비해 주셔서'라는 리뷰로 이어졌습니다.",
      },
    ],
    results: [
